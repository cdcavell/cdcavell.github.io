...
In `Sitemap().Create()` method I dynamicly create a sitemap.xml file after which the following code is performed using `HttpClient` to submit sitemap.xml to Google.
